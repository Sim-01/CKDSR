...
parser.add_argument('--model', default='unet',
                    help='model name')
parser.add_argument('--modelS', default='unet_s',
                    help='model name')
...
parser.add_argument('--dir_data_root', type=str, default='D:/Wang-Linrong/SRResolution/src/data/',
...
# parser.add_argument('--data_range', type=str, default='1-50/1301-1450',
